# Graph Report - deeplogic  (2026-06-21)

## Corpus Check
- 310 files · ~278,270 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2211 nodes · 4334 edges · 144 communities (126 shown, 18 thin omitted)
...
Cohesion: 0.09
Nodes (35): callJson(), DEFAULT_MODEL, ENTITY_TYPES, EntityRow, ExtractedEntity, ExtractedFact, Extraction, extractKnowledge() (+27 more)

### Community 4 - "Dashboard UI Components"
Cohesion: 0.15
Nodes (15): pick(), randomAgentName(), mapWebcam(), playerEmbed(), windyGetWebcam(), windySearchWebcams(), windyTestKey(), WindyWebcam (+7 more)
...
Cohesion: 0.11
Nodes (14): adminRouter, alertsRouter, billingRouter, buildWidgetContext(), dashboardsRouter, fetchConnectorData(), parseConnectorUrl(), openDataRouter (+6 more)
...
Cohesion: 0.12
Nodes (22): DB: studio_projects table, ContextRow, ProjectListRow, ProjectRow, AgentEvent, AgentStage, Anomaly, AskAnswer (+14 more)
...
Cohesion: 0.04
Nodes (64): AdminUserAction, AgentEventKind, AgentRunStreamEvent, AiKeyTestResult, AiProvider, AiProviderState, AiSettings, AlertBody (+56 more)
...
Cohesion: 0.09
Nodes (24): addVaultItem(), generateStudioReport(), getCompiledContext(), getStudioProject(), PromptAttachment, removeVaultItem(), StudioMessage, StudioProject (+16 more)
...
Cohesion: 0.06
Nodes (31): deleteVaultEntry(), deleteVaultKpi(), describePowerBi(), getOrgVault(), getVaultDocContent(), listVaultKpis(), listVaultPowerBI(), testConnectorUrl() (+23 more)
...
Cohesion: 0.13
Nodes (20): GalleryEditModal(), isGalleryWidget(), generateOrgWidget(), getOrgWidget(), getWindyWebcam(), searchWeb(), searchWindyWebcams(), updateOrgWidget() (+12 more)
...
Cohesion: 0.07
Nodes (22): AgentRun, AgentRunEvent, getAgentRun(), getMemoryGraph(), listAgentRuns(), MemoryGraphData, rebuildMemory(), attr() (+14 more)

### Community 31 - "Community 31"
Cohesion: 0.15
Nodes (13): createWidget(), DbColumnInfo, DbSchemaInfo, DbTableInfo, buildDataBlockHtml(), DataBlockConfig, Agg, DataBlockBuilder() (+5 more)
...
Cohesion: 0.15
Nodes (10): ChatTurn, GlobalChat(), QUICK_POOL, render(), assistantChat(), AssistantMessage, AssistantStep, generateMdTitle() (+2 more)
...
Cohesion: 0.14
Nodes (23): DB: org_members table, orgsRouter, Role, ROLES, callerRole(), checkMemberLimit(), requireRole(), addMemberByEmail() (+15 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (22): AiSettingsRow, ALL_PROVIDERS, esc(), gatherSiteInsights(), insightWidgetHtml(), KpiAgg, ProviderEntry, ProviderMap (+14 more)

### Community 49 - "Community 49"
Cohesion: 0.14
Nodes (25): SAMPLES, store, DB: models table, demoRouter, DemoSession, evictStale(), put(), store (+17 more)

### Community 50 - "Community 50"
Cohesion: 0.10
Nodes (28): useAuth(), Shared Domain Types (client copy of server/src/types.ts), SuggestGoalsModal(), acceptInviteToken(), GoalSuggestion, API Client, suggestGoals(), Supabase Client (+20 more)
...
Cohesion: 0.13
Nodes (22): ThemeManager(), createSandbox(), killSandbox(), updateSandbox(), DashboardEditor(), PaneTab, PreviewPane(), Props (+14 more)
...
Cohesion: 0.12
Nodes (14): EVENT_ICON, MISSION, NAME_ADJ, NAME_NOUN, PROVIDERS, REGIONS, SIZES, STATUS (+6 more)
...
Cohesion: 0.14
Nodes (17): inviteRouter, meRouter, checkReportLimit(), readToken(), requireAuth(), requireFeature(), Express.Request Augmentation (user/token/db), acceptInvitation() (+9 more)

### Community 81 - "Community 81"
Cohesion: 0.22
Nodes (8): AuthProvider(), AppShell(), CompetitorsPage(), ProductsPage(), App(), AppIndex(), Competitors(), Products()

### Community 82 - "Community 82"
Cohesion: 0.10
Nodes (24): AgentActivityToasts(), linkify(), renderStepText(), activities, Activity, ActivityStep, emit(), endActivity() (+16 more)

### Community 83 - "Community 83"
Cohesion: 0.15
Nodes (23): StudioMessage, AiConfig, buildMessages(), buildUserMessage(), callAnthropic(), callOpenAICompatible(), CallResult, DEFAULT_MODEL (+15 more)

### Community 84 - "Community 84"
Cohesion: 0.13
Nodes (14): AuthContext, AuthContextValue, AuthUser, RequireAuth(), OrgSwitcher(), getMe(), OrgMembership, anonKey (+6 more)

### Community 85 - "Community 85"
Cohesion: 0.11
Nodes (15): createStudioProject(), deleteStudioProject(), Idea, IdeasResult, IdeaTarget, listStudioProjects(), StudioProjectListItem, suggestIdeas() (+7 more)
...
Cohesion: 0.21
Nodes (13): applyCheckResult(), buildContext(), checkAllActiveAlerts(), CheckResult, evaluateCondition(), evaluateStructured(), fetchTimeout(), getPath() (+5 more)
...
Cohesion: 0.29
Nodes (10): braveSearch(), ddgInstantAnswer(), decodeEntities(), duckDuckGoSearch(), stripTags(), unwrapDdgUrl(), webSearch(), WebSearchResult (+2 more)

### Community 93 - "Community 93"
Cohesion: 0.31
Nodes (10): AgentProvider, AgentRuntime, failAgent(), logEvent(), provisionExternalAgent(), ProvisionParams, runOrgoAgent(), orgoEnsureWorkspace() (+2 more)
...
Cohesion: 0.36
Nodes (10): normalizeComputer(), OrgoComputer, orgoCreateComputer(), orgoDestroy(), orgoGetComputer(), orgoReq(), orgoRunMission(), orgoStop() (+2 more)
...
Cohesion: 0.29
Nodes (6): AdminMail(), BLANK, getMailSettings(), MailSettings, saveMailSettings(), testMailSettings()
...
Cohesion: 0.50
Nodes (3): RequireAdmin(), State, adminMe()
...
Cohesion: 0.20
Nodes (7): VaultPowerBI, baseName(), buildInsight(), connDetail(), ConnLike, PowerBiScanModal(), ScanFacts
...
Cohesion: 0.17
Nodes (12): allGalleryBlocks(), DB_ROWS, dbToGalleryBlock(), GALLERY_CATEGORIES, galleryBlockById(), GalleryCategory, GalleryField, js() (+4 more)

### Community 127 - "Community 127"
Cohesion: 0.07
Nodes (23): ContextItem, ContextKind, ContextScope, createContext(), deleteContext(), hostImage(), listContext(), ProductSuggestion (+15 more)

### Community 128 - "Community 128"
Cohesion: 0.14
Nodes (17): EMPTY, loadMailSettings(), MailSettings, saveMailSettings(), sendMail(), sendTestMail(), transport(), adminEmails() (+9 more)
...
Cohesion: 0.19
Nodes (12): useDashboardScope(), deleteOrgWidget(), Dashboards(), fmtDate(), NEW_TYPES, Tab, TABS, TYPE_ICONS (+4 more)

### Community 132 - "Community 132"
Cohesion: 0.12
Nodes (12): AdminCannaraDemo(), cad(), dayKey(), Harvest, Reading, Room, Sale, NAV (+4 more)
...
Cohesion: 0.33
Nodes (8): DB: audit_entries table, DB: context_items table, DB: org_ai_settings table, DB: organizations table, modelsRouter, insertAudit(), listAudit(), listModels()
...
Cohesion: 0.10
Nodes (19): Alert, AlertConfig, AlertEvent, AlertKind, checkAlert(), createAlert(), deleteAlert(), listAlertEvents() (+11 more)
...
Cohesion: 0.16
Nodes (14): LibraryItem, Props, TYPES, deleteWidget(), generateWidget(), getDashboard(), listGalleryBlocks(), listOrgWidgets() (+6 more)
...
## Knowledge Gaps
- **740 isolated node(s):** `meta`, `meta`, `meta`, `items`, `name` (+735 more)
...
- **Why does `SemanticModel Interface` connect `Community 49` to `Demo Data & Sample Models`, `Community 102`, `Community 14`, `Community 47`, `Auth Pages & Logo`, `Vault & Studio API`, `Community 83`?**
  _High betweenness centrality (0.267) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 50` to `Community 131`, `Community 132`, `Community 133`, `Community 136`, `Community 137`, `Community 140`, `API Client HTTP Functions`, `Community 143`, `Vault & Studio API`, `Studio Project CRUD`, `Vault Browser UI`, `Auth Context & User Model`, `Navigation & Theme`, `Community 30`, `Community 31`, `App Bootstrap`, `Community 45`, `Community 52`, `Community 53`, `Community 54`, `Community 79`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 94`, `Community 101`, `Community 102`, `Community 105`, `Community 121`, `Community 124`, `Community 127`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `AuditEntry Interface` connect `Community 102` to `Vault & Studio API`, `Community 47`, `Community 134`, `Community 49`?**
