# Graph Report - deeplogic  (2026-06-16)

## Corpus Check
- 163 files · ~153,416 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1152 nodes · 2250 edges · 82 communities (67 shown, 15 thin omitted)
...
Cohesion: 0.12
Nodes (9): ALL_PROVIDERS, loadAiConfig(), loadAiRow(), ProviderEntry, ProviderMap, VAULT_KINDS, VaultConnectorRow, VaultDocumentRow (+1 more)
...
Cohesion: 0.10
Nodes (29): ConnectorsStrip(), KIND_LABEL, DimensionBreakdown(), DimensionBreakdownProps, DateRange, Filters(), FiltersProps, computeDelta() (+21 more)
...
Cohesion: 0.06
Nodes (54): AgentRow, agentsRouter, ALLOWED_MODELS, ALLOWED_SCHEDULES, Connector Interface, ALLOWED_MODELS, ALLOWED_SCHEDULES, callAnthropic() (+46 more)
...
Cohesion: 0.22
Nodes (16): buildMessages(), buildUserMessage(), callAnthropic(), callOpenAICompatible(), CallResult, DEFAULT_MODEL, escapeHtml(), generateReport() (+8 more)
...
Cohesion: 0.15
Nodes (18): AnomalyCard(), AnomalyCardProps, AuditLog(), deltaPct(), formatCurrency(), formatDate(), formatNumber(), formatTs() (+10 more)

### Community 12 - "API Client HTTP Functions"
Cohesion: 0.09
Nodes (25): addMemberByEmail(), cancelInvitation(), createCheckoutSession(), createOrg(), createPortalSession(), deleteDashboard(), getMe(), getWidget() (+17 more)
...
Cohesion: 0.14
Nodes (12): ALLOWED, DropZone(), Props, PipelineConsole(), Props, STAGES, BLURBS, Props (+4 more)

### Community 15 - "Core Auth & Navigation"
Cohesion: 0.14
Nodes (9): LogoProps, acceptInviteToken(), AcceptInvite(), InviteInfo, Login(), Cycle, Tier, TIERS (+1 more)

### Community 16 - "Auth Pages & Logo"
Cohesion: 0.13
Nodes (16): ProjectListRow, ProjectRow, AgentEvent, AgentStage, Anomaly, AskAnswer, AuditEntry, Connector (+8 more)
...
Cohesion: 0.20
Nodes (7): createStudioProject(), deleteStudioProject(), listStudioProjects(), StudioProjectListItem, StudioVisibility, StartMode, Tab
...
Cohesion: 0.14
Nodes (21): DB: org_members table, orgsRouter, Role, ROLES, callerRole(), checkMemberLimit(), requireRole(), addMemberByEmail() (+13 more)

### Community 23 - "Vault Browser UI"
Cohesion: 0.11
Nodes (17): deleteVaultEntry(), getOrgVault(), getVaultDocContent(), ingestToVault(), testConnectorUrl(), updateVaultMcp(), updateVaultModelConnector(), VaultConnector (+9 more)

### Community 24 - "Context Library CRUD"
Cohesion: 0.17
Nodes (8): ContextKind, ContextScope, deleteContext(), summarizeDocument(), updateContext(), AddKind, KIND_LABEL, Props
...
Cohesion: 0.20
Nodes (10): AuthContext, AuthContextValue, AuthProvider(), AuthUser, OrgMembership, anonKey, supabase, url (+2 more)
...
Cohesion: 0.15
Nodes (13): ADMIN_EMAILS, initials(), Nav(), TrialBadge(), TrialBadgeProps, trialCache, UserMenu(), OrgSwitcher() (+5 more)
...
Cohesion: 0.27
Nodes (10): createSandbox(), killSandbox(), updateSandbox(), PaneTab, PreviewPane(), Props, applyReportTheme(), reportTheme Utilities (+2 more)
...
Cohesion: 0.50
Nodes (3): Graphify-First PreToolUse Hook, App(), build-deeplogic Foundation Workflow
...
Cohesion: 0.14
Nodes (11): billingRouter, buildWidgetContext(), dashboardsRouter, fetchConnectorData(), parseConnectorUrl(), sandboxRouter, BraveResponse, BraveResult (+3 more)

### Community 48 - "Community 48"
Cohesion: 0.10
Nodes (22): LibraryItem, Props, TYPES, createContext(), deleteWidget(), generateOrgWidget(), generateWidget(), getDashboard() (+14 more)

### Community 49 - "Community 49"
Cohesion: 0.20
Nodes (12): inviteRouter, meRouter, checkReportLimit(), readToken(), requireAuth(), Express.Request Augmentation (user/token/db), acceptInvitation(), getInvitationByToken() (+4 more)
...
Cohesion: 0.18
Nodes (6): alertsRouter, AiSettingsRow, inviteEmailHtml(), sendEmail(), SendOptions, AiProvider

### Community 52 - "Community 52"
Cohesion: 0.12
Nodes (17): Agent, createAgent(), createAgentsBulk(), deleteAgent(), listAgents(), ProposedAgent, suggestAgentTeam(), updateAgent() (+9 more)

### Community 53 - "Community 53"
Cohesion: 0.18
Nodes (10): createDashboard(), createWidget(), deleteOrgWidget(), listOrgWidgets(), Dashboards(), fmtDate(), NEW_TYPES, Tab (+2 more)
...
Cohesion: 0.28
Nodes (7): embedText(), MatchRow, profileText(), resolveEmbeddingKey(), retrieveRelevant(), toVectorLiteral(), AiConfig
...
Cohesion: 0.07
Nodes (49): AskPanel(), formatValue(), SUGGESTIONS, AdminUserAction, AiKeyTestResult, AiProvider, AiProviderState, AiSettings (+41 more)
...
Cohesion: 0.23
Nodes (13): DB: audit_entries table, DB: models table, DB: org_ai_settings table, DB: organizations table, DB: studio_projects table, AuditLogProps, modelsRouter, createOrgWithSeed() (+5 more)
...
Cohesion: 0.39
Nodes (8): DB: context_items table, ContextRow, ContextItem, VaultItem, compileContext(), fetchUrlContent(), formatKpiValue(), renderVault()

### Community 81 - "Community 81"
Cohesion: 0.18
Nodes (13): useAuth(), RequireAdmin(), State, RequireAuth(), DashboardSwitcher(), adminMe(), listDashboards(), DashboardsList() (+5 more)

## Knowledge Gaps
- **417 isolated node(s):** `meta`, `meta`, `meta`, `name`, `version` (+412 more)
...
- **Why does `SemanticModel Interface` connect `Server API & Database Layer` to `Demo Data & Sample Models`, `Analytics & Anomaly Engine`, `Dashboard UI Components`, `Frontend API Client`, `Community 80`, `Auth Pages & Logo`, `Client Domain Types`, `Community 60`, `Community 63`?**
  _High betweenness centrality (0.235) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 81` to `Dashboard UI Components`, `API Client HTTP Functions`, `Ingest UI Pipeline`, `Core Auth & Navigation`, `Vault & Studio API`, `Studio Project CRUD`, `Studio Chat Interface`, `Vault Browser UI`, `Context Library CRUD`, `Auth Context & User Model`, `Navigation & Theme`, `AI Provider Settings`, `Report Preview & Theming`, `Community 48`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 60`, `Community 62`, `Community 64`, `Community 79`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `AuditEntry Interface` connect `Community 63` to `Server API & Database Layer`, `Community 60`, `Client Domain Types`?**
